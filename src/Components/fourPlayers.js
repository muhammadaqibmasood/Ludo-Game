...
class Routes extends Component {
  constructor(props){
    ...
    console.log(props);
              ...
              state={
                playerNo : 1,redNo:4,greenNo:4,yellowNo:4,blueNo:4,blue:[],red:[],green:[],yellow:[],
                   red0:0,
                   red1:0,
                   red2:0,
                   red3:0,
   ...
   this.update();
             ...
             update(){
                ...
                if(playerNo===1){
                  ...
                  this.state.winner.push('Blue Player is at Position ');}
                ...
                if ((this.score<6&&blue.length===0)||document.getElementById('stop1').getElementsByTagName('img').length===4) {
                  ...
                  this.setState((prevState)=>{return {playerNo :prevState.playerNo + 1} },()=>this.calback1());
              ...
              if(playerNo===2){
                if(document.getElementById('stop2').getElementsByTagName('img').length===4){
                  this.state.winner.push('Red Player is at Position ')}
                ...
                if(playerNo===3){
                  if(document.getElementById('stop3').getElementsByTagName('img').length===4){
                    this.state.winner.push('Green Player is at Position ')
                ...
                if(playerNo===4){
                  ...
                  if(document.getElementById('stop4').getElementsByTagName('img').length===4){
                    this.state.winner.push('Yellow Player is at Position');}
              ...
              if ((this.score<6&&yellow.length===0)||document.getElementById('stop4').getElementsByTagName('img').length===4) {
               ...
               calback1=()=>{
                ...
                if(document.getElementById('stop1').getElementsByTagName('img').length===4){
                  ...
                  this.setState((prevState)=>{return {playerNo :prevState.playerNo + 1} },()=>{try{this.calback2()}catch{}});
                }}
                 if(playerNo===2){
                if(document.getElementById('stop2').getElementsByTagName('img').length===4){
                  this.setState((prevState)=>{return {playerNo :prevState.playerNo + 1} },()=>{try{this.calback2()}catch{}});
                ...
                if(document.getElementById('stop3').getElementsByTagName('img').length===4){
                 ...
                 if(playerNo===4){
                    ...
                    if(document.getElementById('stop4').getElementsByTagName('img').length===4){
                    const playerNo=1;
                    this.setState({playerNo},()=>{try{this.calback2()}catch{}})}
                  }
                  if(this.state.winner.length===3){
                    this.setState({gameover:true})
                  } 
               ...
               calback2=()=>{
                ...
                if(document.getElementById('stop1').getElementsByTagName('img').length===4){
                  ...
                  this.setState((prevState)=>{return {playerNo :prevState.playerNo + 1} },()=>{try{this.calback3()}catch{}});
                }}
                 if(playerNo===2){
                if(document.getElementById('stop2').getElementsByTagName('img').length===4){
                  this.setState((prevState)=>{return {playerNo :prevState.playerNo + 1} },()=>{try{this.calback3()}catch{}});
                ...
                if(document.getElementById('stop3').getElementsByTagName('img').length===4){
                 ...
                 if(playerNo===4){
                    ...
                    if(document.getElementById('stop4').getElementsByTagName('img').length===4){
                    const playerNo=1;
                    this.setState({playerNo},()=>{try{this.calback3()}catch{}});}
                  }
                  if(this.state.winner.length===3){
                    this.setState({gameover:true})
                  }
  ...
  this.state.green.shift();  
      ...
      render(){
        ...
        console.log('winner',this.state.winner);
                  ...
                  console.log('winner length',typeof(this.state.winner.length));
                  return (
                    <div id='table'>
